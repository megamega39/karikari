...
static void LoadJa()
{
    g_strings = {
        ...
        {L"nav.toggle_bars", L"バーを隠して広く表示"},
        ...
        {L"kb.binding",     L"綴じ方向"},
        {L"kb.rotate",      L"回転"},
        {L"kb.prev_page",      L"前のページ"},
        {L"kb.next_page",      L"次のページ"},
        {L"kb.first_page",     L"最初のページ"},
        {L"kb.last_page",      L"最後のページ"},
        {L"kb.prev_archive",   L"前の書庫"},
        {L"kb.next_archive",   L"次の書庫"},
        {L"kb.nav_back",       L"戻る"},
        {L"kb.nav_forward",    L"進む"},
        {L"kb.nav_up",         L"親フォルダへ"},
        {L"kb.open_item",      L"開く/展開・折畳み"},
        {L"kb.fullscreen",     L"全画面切替"},
        {L"kb.zoom_reset",     L"ズームリセット"},
        {L"kb.copy_image",     L"画像コピー"},
        {L"kb.rotate_ccw",     L"反時計回り回転"},
        {L"kb.rename",         L"名前変更"},
        {L"kb.delete_file",    L"ファイル削除"},
        {L"kb.play_pause",     L"再生/一時停止"},
        {L"kb.refresh",        L"更新"},
        {L"kb.help",           L"ヘルプ"},
        {L"kb.escape",         L"全画面解除"},
        {L"kb.bookshelf",      L"本棚切替"},
        {L"kb.history",        L"履歴切替"},
        {L"kb.list_view",      L"リスト表示"},
        {L"kb.grid_view",      L"グリッド表示"},
        {L"kb.hover_preview",  L"ホバープレビュー"},
        {L"kb.settings",       L"設定"},
        {L"kb.view_cycle",     L"表示モード切替"},
        {L"kb.bind_ltr",       L"左綴じ"},
        {L"kb.bind_rtl",       L"右綴じ"},
        // コンテキストメニュー（本棚）
        ...
        {L"help.subtitle",      L"画像・動画・書庫ビューア"},
        {L"help.authorlabel",   L"作者:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"説明:"},
        {L"help.desc1",         L"ZIP/RAR/7z 書庫をそのまま閲覧。見開き表示や動画再生にも対応。"},
        {L"help.desc2",         L""},
        {L"help.close",         L"閉じる"},
        {L"help.checkupdate",    L"更新を確認"},
        {L"help.update.checking", L"確認中..."},
        {L"help.update.latest",  L"最新バージョンです"},
        {L"help.update.available", L"v%s が利用可能です"},
        {L"help.update.error",   L"確認できませんでした"},
        {L"help.update.download", L"ダウンロード"},
        {L"help.text.basic",
            L"■ 画像を見る\r\n"
...
static void LoadEn()
{
    g_strings = {
        ...
        {L"kb.prev_page",      L"Previous Page"},
        {L"kb.next_page",      L"Next Page"},
        {L"kb.first_page",     L"First Page"},
        {L"kb.last_page",      L"Last Page"},
        {L"kb.prev_archive",   L"Previous Archive"},
        {L"kb.next_archive",   L"Next Archive"},
        {L"kb.nav_back",       L"Back"},
        {L"kb.nav_forward",    L"Forward"},
        {L"kb.nav_up",         L"Parent Folder"},
        {L"kb.open_item",      L"Open / Expand"},
        {L"kb.fullscreen",     L"Fullscreen"},
        {L"kb.zoom_reset",     L"Reset Zoom"},
        {L"kb.copy_image",     L"Copy Image"},
        {L"kb.rotate_ccw",     L"Rotate CCW"},
        {L"kb.rename",         L"Rename"},
        {L"kb.delete_file",    L"Delete File"},
        {L"kb.play_pause",     L"Play/Pause"},
        {L"kb.refresh",        L"Refresh"},
        {L"kb.help",           L"Help"},
        {L"kb.escape",         L"Exit Fullscreen"},
        {L"kb.bookshelf",      L"Toggle Bookshelf"},
        {L"kb.history",        L"Toggle History"},
        {L"kb.list_view",      L"List View"},
        {L"kb.grid_view",      L"Grid View"},
        {L"kb.hover_preview",  L"Hover Preview"},
        {L"kb.settings",       L"Settings"},
        {L"kb.view_cycle",     L"Cycle View Mode"},
        {L"kb.bind_ltr",       L"Left Binding"},
        {L"kb.bind_rtl",       L"Right Binding"},
        ...
        {L"media.speed",        L"Playback Speed"},
        ...
        {L"help.subtitle",      L"Image, video & archive viewer"},
        {L"help.authorlabel",   L"Author:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Description:"},
        {L"help.desc1",         L"Browse ZIP/RAR/7z archives directly. Supports spread view and video playback."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Close"},
        {L"help.checkupdate",    L"Check for Updates"},
        {L"help.update.checking", L"Checking..."},
        {L"help.update.latest",  L"You are using the latest version"},
        {L"help.update.available", L"v%s is available"},
        {L"help.update.error",   L"Could not check for updates"},
        {L"help.update.download", L"Download"},
        {L"help.text.basic",
            L"## Viewing Images\r\n"
...
static void LoadZhCN()
{
    g_strings = {
        ...
        {L"kb.binding",     L"装订方向"},
        {L"kb.rotate",      L"旋转"},
        {L"kb.prev_page",      L"上一页"},
        {L"kb.next_page",      L"下一页"},
        {L"kb.first_page",     L"第一页"},
        {L"kb.last_page",      L"最后一页"},
        {L"kb.prev_archive",   L"上一书库"},
        {L"kb.next_archive",   L"下一书库"},
        {L"kb.nav_back",       L"后退"},
        {L"kb.nav_forward",    L"前进"},
        {L"kb.nav_up",         L"上级文件夹"},
        {L"kb.open_item",      L"打开/展开"},
        {L"kb.fullscreen",     L"全屏切换"},
        {L"kb.zoom_reset",     L"重置缩放"},
        {L"kb.copy_image",     L"复制图像"},
        {L"kb.rotate_ccw",     L"逆时针旋转"},
        {L"kb.rename",         L"重命名"},
        {L"kb.delete_file",    L"删除文件"},
        {L"kb.play_pause",     L"播放/暂停"},
        {L"kb.refresh",        L"刷新"},
        {L"kb.help",           L"帮助"},
        {L"kb.escape",         L"退出全屏"},
        {L"kb.bookshelf",      L"切换书架"},
        {L"kb.history",        L"切换历史"},
        {L"kb.list_view",      L"列表视图"},
        {L"kb.grid_view",      L"网格视图"},
        {L"kb.hover_preview",  L"悬停预览"},
        {L"kb.settings",       L"设置"},
        {L"kb.view_cycle",     L"切换视图模式"},
        {L"kb.bind_ltr",       L"左装订"},
        {L"kb.bind_rtl",       L"右装订"},
        ...
        {L"help.subtitle",      L"图片・视频・压缩包查看器"},
        {L"help.authorlabel",   L"作者:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"说明:"},
        {L"help.desc1",         L"直接浏览 ZIP/RAR/7z 压缩包。支持跨页显示和视频播放。"},
        {L"help.desc2",         L""},
        {L"help.close",         L"关闭"},
        {L"help.checkupdate",    L"检查更新"},
        {L"help.update.checking", L"检查中..."},
        {L"help.update.latest",  L"已是最新版本"},
        {L"help.update.available", L"v%s 可用"},
        {L"help.update.error",   L"无法检查更新"},
        {L"help.update.download", L"下载"},
        {L"help.text.basic",
            L"## 查看图片\r\n"
...
static void LoadZhTW()
{
    g_strings = {
        ...
        {L"kb.binding",     L"裝訂方向"},
        {L"kb.rotate",      L"旋轉"},
        {L"kb.prev_page",      L"上一頁"},
        {L"kb.next_page",      L"下一頁"},
        {L"kb.first_page",     L"第一頁"},
        {L"kb.last_page",      L"最後一頁"},
        {L"kb.prev_archive",   L"上一書庫"},
        {L"kb.next_archive",   L"下一書庫"},
        {L"kb.nav_back",       L"後退"},
        {L"kb.nav_forward",    L"前進"},
        {L"kb.nav_up",         L"上層資料夾"},
        {L"kb.open_item",      L"開啟/展開"},
        {L"kb.fullscreen",     L"全螢幕切換"},
        {L"kb.zoom_reset",     L"重設縮放"},
        {L"kb.copy_image",     L"複製影像"},
        {L"kb.rotate_ccw",     L"逆時針旋轉"},
        {L"kb.rename",         L"重新命名"},
        {L"kb.delete_file",    L"刪除檔案"},
        {L"kb.play_pause",     L"播放/暫停"},
        {L"kb.refresh",        L"重新整理"},
        {L"kb.help",           L"說明"},
        {L"kb.escape",         L"退出全螢幕"},
        {L"kb.bookshelf",      L"切換書架"},
        {L"kb.history",        L"切換歷史"},
        {L"kb.list_view",      L"清單檢視"},
        {L"kb.grid_view",      L"格線檢視"},
        {L"kb.hover_preview",  L"懸停預覽"},
        {L"kb.settings",       L"設定"},
        {L"kb.view_cycle",     L"切換檢視模式"},
        {L"kb.bind_ltr",       L"左裝訂"},
        {L"kb.bind_rtl",       L"右裝訂"},
        ...
        {L"help.version",       L"版本 1.0.0"},
        {L"help.subtitle",      L"圖片・影片・壓縮檔檢視器"},
        {L"help.authorlabel",   L"作者:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"說明:"},
        {L"help.desc1",         L"直接瀏覽 ZIP/RAR/7z 壓縮檔。支援跨頁顯示和影片播放。"},
        {L"help.desc2",         L""},
        {L"help.close",         L"關閉"},
        {L"help.checkupdate",    L"檢查更新"},
        {L"help.update.checking", L"檢查中..."},
        {L"help.update.latest",  L"已是最新版本"},
        {L"help.update.available", L"v%s 可用"},
        {L"help.update.error",   L"無法檢查更新"},
        {L"help.update.download", L"下載"},
        {L"help.text.basic",
            L"## 檢視圖片\r\n"
...
static void LoadKo()
{
    g_strings = {
        ...
        {L"kb.rotate",      L"회전"},
        {L"kb.prev_page",      L"이전 페이지"},
        {L"kb.next_page",      L"다음 페이지"},
        {L"kb.first_page",     L"첫 페이지"},
        {L"kb.last_page",      L"마지막 페이지"},
        {L"kb.prev_archive",   L"이전 아카이브"},
        {L"kb.next_archive",   L"다음 아카이브"},
        {L"kb.nav_back",       L"뒤로"},
        {L"kb.nav_forward",    L"앞으로"},
        {L"kb.nav_up",         L"상위 폴더"},
        {L"kb.open_item",      L"열기/확장"},
        {L"kb.fullscreen",     L"전체화면 전환"},
        {L"kb.zoom_reset",     L"확대/축소 재설정"},
        {L"kb.copy_image",     L"이미지 복사"},
        {L"kb.rotate_ccw",     L"반시계 방향 회전"},
        {L"kb.rename",         L"이름 바꾸기"},
        {L"kb.delete_file",    L"파일 삭제"},
        {L"kb.play_pause",     L"재생/일시정지"},
        {L"kb.refresh",        L"새로고침"},
        {L"kb.help",           L"도움말"},
        {L"kb.escape",         L"전체화면 종료"},
        {L"kb.bookshelf",      L"책장 전환"},
        {L"kb.history",        L"히스토리 전환"},
        {L"kb.list_view",      L"목록 보기"},
        {L"kb.grid_view",      L"그리드 보기"},
        {L"kb.hover_preview",  L"호버 미리보기"},
        {L"kb.settings",       L"설정"},
        {L"kb.view_cycle",     L"보기 모드 전환"},
        {L"kb.bind_ltr",       L"왼쪽 제본"},
        {L"kb.bind_rtl",       L"오른쪽 제본"},
        ...
        {L"help.subtitle",      L"이미지・동영상・아카이브 뷰어"},
        {L"help.authorlabel",   L"제작자:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"설명:"},
        {L"help.desc1",         L"ZIP/RAR/7z 아카이브를 직접 열람. 펼침 보기와 동영상 재생 지원."},
        {L"help.desc2",         L""},
        {L"help.close",         L"닫기"},
        {L"help.checkupdate",    L"업데이트 확인"},
        {L"help.update.checking", L"확인 중..."},
        {L"help.update.latest",  L"최신 버전입니다"},
        {L"help.update.available", L"v%s 사용 가능"},
        {L"help.update.error",   L"업데이트를 확인할 수 없습니다"},
        {L"help.update.download", L"다운로드"},
        {L"help.text.basic",
            L"## 이미지 보기\r\n"
...
static void LoadEs()
{
    g_strings = {
        ...
        {L"nav.toggle_bars", L"Ocultar barras"},
        ...
        {L"kb.rotate",      L"Rotar"},
        {L"kb.prev_page",      L"Página anterior"},
        {L"kb.next_page",      L"Página siguiente"},
        {L"kb.first_page",     L"Primera página"},
        {L"kb.last_page",      L"Última página"},
        {L"kb.prev_archive",   L"Archivo anterior"},
        {L"kb.next_archive",   L"Archivo siguiente"},
        {L"kb.nav_back",       L"Atrás"},
        {L"kb.nav_forward",    L"Adelante"},
        {L"kb.nav_up",         L"Carpeta principal"},
        {L"kb.open_item",      L"Abrir/Expandir"},
        {L"kb.fullscreen",     L"Pantalla completa"},
        {L"kb.zoom_reset",     L"Restablecer zoom"},
        {L"kb.copy_image",     L"Copiar imagen"},
        {L"kb.rotate_ccw",     L"Girar CCW"},
        {L"kb.rename",         L"Renombrar"},
        {L"kb.delete_file",    L"Eliminar archivo"},
        {L"kb.play_pause",     L"Reproducir/Pausa"},
        {L"kb.refresh",        L"Actualizar"},
        {L"kb.help",           L"Ayuda"},
        {L"kb.escape",         L"Salir de pantalla completa"},
        {L"kb.bookshelf",      L"Alternar estantería"},
        {L"kb.history",        L"Alternar historial"},
        {L"kb.list_view",      L"Vista de lista"},
        {L"kb.grid_view",      L"Vista de cuadrícula"},
        {L"kb.hover_preview",  L"Vista previa"},
        {L"kb.settings",       L"Configuración"},
        {L"kb.view_cycle",     L"Cambiar modo de vista"},
        {L"kb.bind_ltr",       L"Encuadernación izquierda"},
        {L"kb.bind_rtl",       L"Encuadernación derecha"},
        ...
        {L"media.speed",        L"Velocidad de reproducción"},
        ...
        {L"help.subtitle",      L"Visor de imágenes, vídeos y archivos"},
        {L"help.authorlabel",   L"Autor:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Descripción:"},
        {L"help.desc1",         L"Explore archivos ZIP/RAR/7z directamente. Compatible con vista doble y reproducción de vídeo."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Cerrar"},
        {L"help.checkupdate",    L"Buscar actualizaciones"},
        {L"help.update.checking", L"Comprobando..."},
        {L"help.update.latest",  L"Tienes la última versión"},
        {L"help.update.available", L"v%s disponible"},
        {L"help.update.error",   L"No se pudo comprobar"},
        {L"help.update.download", L"Descargar"},
        {L"help.text.basic",
            L"## Ver imágenes\r\n"
...
static void LoadPtBR()
{
    g_strings = {
        ...
        {L"kb.rotate",      L"Girar"},
        {L"kb.prev_page",      L"Página anterior"},
        {L"kb.next_page",      L"Próxima página"},
        {L"kb.first_page",     L"Primeira página"},
        {L"kb.last_page",      L"Última página"},
        {L"kb.prev_archive",   L"Arquivo anterior"},
        {L"kb.next_archive",   L"Próximo arquivo"},
        {L"kb.nav_back",       L"Voltar"},
        {L"kb.nav_forward",    L"Avançar"},
        {L"kb.nav_up",         L"Pasta pai"},
        {L"kb.open_item",      L"Abrir/Expandir"},
        {L"kb.fullscreen",     L"Tela cheia"},
        {L"kb.zoom_reset",     L"Redefinir zoom"},
        {L"kb.copy_image",     L"Copiar imagem"},
        {L"kb.rotate_ccw",     L"Girar CCW"},
        {L"kb.rename",         L"Renomear"},
        {L"kb.delete_file",    L"Excluir arquivo"},
        {L"kb.play_pause",     L"Reproduzir/Pausar"},
        {L"kb.refresh",        L"Atualizar"},
        {L"kb.help",           L"Ajuda"},
        {L"kb.escape",         L"Sair da tela cheia"},
        {L"kb.bookshelf",      L"Alternar estante"},
        {L"kb.history",        L"Alternar histórico"},
        {L"kb.list_view",      L"Visão em lista"},
        {L"kb.grid_view",      L"Visão em grade"},
        {L"kb.hover_preview",  L"Pré-visualização"},
        {L"kb.settings",       L"Configurações"},
        {L"kb.view_cycle",     L"Alternar modo de exibição"},
        {L"kb.bind_ltr",       L"Encadernação à esquerda"},
        {L"kb.bind_rtl",       L"Encadernação à direita"},
        ...
        {L"media.speed",        L"Velocidade de reprodução"},
        ...
        {L"help.subtitle",      L"Visualizador de imagens, vídeos e arquivos"},
        {L"help.authorlabel",   L"Autor:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Descrição:"},
        {L"help.desc1",         L"Navegue por arquivos ZIP/RAR/7z diretamente. Suporta visualização dupla e reprodução de vídeo."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Fechar"},
        {L"help.checkupdate",    L"Verificar atualizações"},
        {L"help.update.checking", L"Verificando..."},
        {L"help.update.latest",  L"Você está usando a versão mais recente"},
        {L"help.update.available", L"v%s disponível"},
        {L"help.update.error",   L"Não foi possível verificar"},
        {L"help.update.download", L"Baixar"},
        {L"help.text.basic",
...
static void LoadFr()
{
    g_strings = {
        ...
        {L"nav.toggle_bars", L"Masquer les barres"},
        ...
        {L"kb.prev_page",      L"Page précédente"},
        {L"kb.next_page",      L"Page suivante"},
        {L"kb.first_page",     L"Première page"},
        {L"kb.last_page",      L"Dernière page"},
        {L"kb.prev_archive",   L"Archive précédente"},
        {L"kb.next_archive",   L"Archive suivante"},
        {L"kb.nav_back",       L"Retour"},
        {L"kb.nav_forward",    L"Suivant"},
        {L"kb.nav_up",         L"Dossier parent"},
        {L"kb.open_item",      L"Ouvrir/Déplier"},
        {L"kb.fullscreen",     L"Plein écran"},
        {L"kb.zoom_reset",     L"Réinitialiser le zoom"},
        {L"kb.copy_image",     L"Copier l'image"},
        {L"kb.rotate_ccw",     L"Rotation CCW"},
        {L"kb.rename",         L"Renommer"},
        {L"kb.delete_file",    L"Supprimer le fichier"},
        {L"kb.play_pause",     L"Lecture/Pause"},
        {L"kb.refresh",        L"Actualiser"},
        {L"kb.help",           L"Aide"},
        {L"kb.escape",         L"Quitter plein écran"},
        {L"kb.bookshelf",      L"Basculer bibliothèque"},
        {L"kb.history",        L"Basculer historique"},
        {L"kb.list_view",      L"Vue liste"},
        {L"kb.grid_view",      L"Vue grille"},
        {L"kb.hover_preview",  L"Aperçu au survol"},
        {L"kb.settings",       L"Paramètres"},
        {L"kb.view_cycle",     L"Changer mode d'affichage"},
        {L"kb.bind_ltr",       L"Reliure gauche"},
        {L"kb.bind_rtl",       L"Reliure droite"},
        ...
        {L"media.speed",        L"Vitesse de lecture"},
        ...
        {L"help.version",       L"Version 1.0.0"},
        {L"help.subtitle",      L"Visionneuse d'images, vidéos et archives"},
        {L"help.authorlabel",   L"Auteur :"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Description :"},
        {L"help.desc1",         L"Parcourez les archives ZIP/RAR/7z directement. Prend en charge l'affichage double page et la lecture vidéo."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Fermer"},
        {L"help.checkupdate",    L"Vérifier les mises à jour"},
        {L"help.update.checking", L"Vérification..."},
        {L"help.update.latest",  L"Vous utilisez la dernière version"},
        {L"help.update.available", L"v%s disponible"},
        {L"help.update.error",   L"Impossible de vérifier"},
        {L"help.update.download", L"Télécharger"},
        {L"help.text.basic",
...
static void LoadDe()
{
    g_strings = {
        ...
        {L"nav.toggle_bars", L"Leisten ausblenden"},
        ...
        {L"kb.prev_page",      L"Vorherige Seite"},
        {L"kb.next_page",      L"Nächste Seite"},
        {L"kb.first_page",     L"Erste Seite"},
        {L"kb.last_page",      L"Letzte Seite"},
        {L"kb.prev_archive",   L"Vorheriges Archiv"},
        {L"kb.next_archive",   L"Nächstes Archiv"},
        {L"kb.nav_back",       L"Zurück"},
        {L"kb.nav_forward",    L"Vorwärts"},
        {L"kb.nav_up",         L"Übergeordneter Ordner"},
        {L"kb.open_item",      L"Öffnen/Erweitern"},
        {L"kb.fullscreen",     L"Vollbild"},
        {L"kb.zoom_reset",     L"Zoom zurücksetzen"},
        {L"kb.copy_image",     L"Bild kopieren"},
        {L"kb.rotate_ccw",     L"Gegen den UZS drehen"},
        {L"kb.rename",         L"Umbenennen"},
        {L"kb.delete_file",    L"Datei löschen"},
        {L"kb.play_pause",     L"Wiedergabe/Pause"},
        {L"kb.refresh",        L"Aktualisieren"},
        {L"kb.help",           L"Hilfe"},
        {L"kb.escape",         L"Vollbild beenden"},
        {L"kb.bookshelf",      L"Bücherregal umschalten"},
        {L"kb.history",        L"Verlauf umschalten"},
        {L"kb.list_view",      L"Listenansicht"},
        {L"kb.grid_view",      L"Rasteransicht"},
        {L"kb.hover_preview",  L"Hover-Vorschau"},
        {L"kb.settings",       L"Einstellungen"},
        {L"kb.view_cycle",     L"Ansichtsmodus wechseln"},
        {L"kb.bind_ltr",       L"Linksbindung"},
        {L"kb.bind_rtl",       L"Rechtsbindung"},
        ...
        {L"media.speed",        L"Wiedergabegeschwindigkeit"},
        ...
        {L"help.version",       L"Version 1.0.0"},
        {L"help.subtitle",      L"Bild-, Video- und Archiv-Viewer"},
        {L"help.authorlabel",   L"Autor:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Beschreibung:"},
        {L"help.desc1",         L"ZIP/RAR/7z-Archive direkt durchsuchen. Unterstützt Doppelseitenansicht und Videowiedergabe."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Schließen"},
        {L"help.checkupdate",    L"Nach Updates suchen"},
        {L"help.update.checking", L"Überprüfe..."},
        {L"help.update.latest",  L"Sie verwenden die neueste Version"},
        {L"help.update.available", L"v%s verfügbar"},
        {L"help.update.error",   L"Konnte nicht überprüfen"},
        {L"help.update.download", L"Herunterladen"},
        {L"help.text.basic",
            L"## Bilder ansehen\r\n"
...
static void LoadRu()
{
    g_strings = {
        ...
        {L"nav.toggle_bars", L"Скрыть панели"},
        ...
        {L"kb.prev_page",      L"Предыдущая страница"},
        {L"kb.next_page",      L"Следующая страница"},
        {L"kb.first_page",     L"Первая страница"},
        {L"kb.last_page",      L"Последняя страница"},
        {L"kb.prev_archive",   L"Предыдущий архив"},
        {L"kb.next_archive",   L"Следующий архив"},
        {L"kb.nav_back",       L"Назад"},
        {L"kb.nav_forward",    L"Вперёд"},
        {L"kb.nav_up",         L"Родительская папка"},
        {L"kb.open_item",      L"Открыть/Развернуть"},
        {L"kb.fullscreen",     L"Полный экран"},
        {L"kb.zoom_reset",     L"Сбросить масштаб"},
        {L"kb.copy_image",     L"Копировать изображение"},
        {L"kb.rotate_ccw",     L"Повернуть против ч.с."},
        {L"kb.rename",         L"Переименовать"},
        {L"kb.delete_file",    L"Удалить файл"},
        {L"kb.play_pause",     L"Воспр./Пауза"},
        {L"kb.refresh",        L"Обновить"},
        {L"kb.help",           L"Справка"},
        {L"kb.escape",         L"Выйти из полного экрана"},
        {L"kb.bookshelf",      L"Переключить книжную полку"},
        {L"kb.history",        L"Переключить историю"},
        {L"kb.list_view",      L"Список"},
        {L"kb.grid_view",      L"Сетка"},
        {L"kb.hover_preview",  L"Предпросмотр при наведении"},
        {L"kb.settings",       L"Настройки"},
        {L"kb.view_cycle",     L"Переключить режим просмотра"},
        {L"kb.bind_ltr",       L"Левый переплёт"},
        {L"kb.bind_rtl",       L"Правый переплёт"},
        ...
        {L"media.speed",        L"Скорость воспроизведения"},
        ...
        {L"help.subtitle",      L"Просмотрщик изображений, видео и архивов"},
        {L"help.authorlabel",   L"Автор:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Описание:"},
        {L"help.desc1",         L"Просмотр архивов ZIP/RAR/7z напрямую. Поддержка разворота и воспроизведения видео."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Закрыть"},
        {L"help.checkupdate",    L"Проверить обновления"},
        {L"help.update.checking", L"Проверка..."},
        {L"help.update.latest",  L"У вас последняя версия"},
        {L"help.update.available", L"Доступна v%s"},
        {L"help.update.error",   L"Не удалось проверить"},
        {L"help.update.download", L"Скачать"},
        {L"help.text.basic",
...
static void LoadVi()
{
    g_strings = {
        ...
        {L"nav.toggle_bars", L"Ẩn thanh công cụ"},
        ...
        {L"kb.rotate",      L"Xoay"},
        {L"kb.prev_page",      L"Trang trước"},
        {L"kb.next_page",      L"Trang kế"},
        {L"kb.first_page",     L"Trang đầu"},
        {L"kb.last_page",      L"Trang cuối"},
        {L"kb.prev_archive",   L"Kho trước"},
        {L"kb.next_archive",   L"Kho kế"},
        {L"kb.nav_back",       L"Quay lại"},
        {L"kb.nav_forward",    L"Tiến"},
        {L"kb.nav_up",         L"Thư mục cha"},
        {L"kb.open_item",      L"Mở/Mở rộng"},
        {L"kb.fullscreen",     L"Toàn màn hình"},
        {L"kb.zoom_reset",     L"Đặt lại thu phóng"},
        {L"kb.copy_image",     L"Sao chép ảnh"},
        {L"kb.rotate_ccw",     L"Xoay ngược chiều"},
        {L"kb.rename",         L"Đổi tên"},
        {L"kb.delete_file",    L"Xoá tệp"},
        {L"kb.play_pause",     L"Phát/Tạm dừng"},
        {L"kb.refresh",        L"Làm mới"},
        {L"kb.help",           L"Trợ giúp"},
        {L"kb.escape",         L"Thoát toàn màn hình"},
        {L"kb.bookshelf",      L"Chuyển đổi giá sách"},
        {L"kb.history",        L"Chuyển đổi lịch sử"},
        {L"kb.list_view",      L"Dạng danh sách"},
        {L"kb.grid_view",      L"Dạng lưới"},
        {L"kb.hover_preview",  L"Xem trước khi rê chuột"},
        {L"kb.settings",       L"Cài đặt"},
        {L"kb.view_cycle",     L"Chuyển chế độ xem"},
        {L"kb.bind_ltr",       L"Đóng gáy trái"},
        {L"kb.bind_rtl",       L"Đóng gáy phải"},
        ...
        {L"help.subtitle",      L"Trình xem ảnh, video và tệp nén"},
        {L"help.authorlabel",   L"Tác giả:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"Mô tả:"},
        {L"help.desc1",         L"Duyệt trực tiếp tệp nén ZIP/RAR/7z. Hỗ trợ xem trang đôi và phát video."},
        {L"help.desc2",         L""},
        {L"help.close",         L"Đóng"},
        {L"help.checkupdate",    L"Kiểm tra cập nhật"},
        {L"help.update.checking", L"Đang kiểm tra..."},
        {L"help.update.latest",  L"Bạn đang dùng phiên bản mới nhất"},
        {L"help.update.available", L"v%s khả dụng"},
        {L"help.update.error",   L"Không thể kiểm tra"},
        {L"help.update.download", L"Tải xuống"},
        {L"help.text.basic",
            L"## Xem ảnh\r\n"
...
static void LoadTh()
{
    g_strings = {
        ...
        {L"kb.rotate",      L"หมุน"},
        {L"kb.prev_page",      L"หน้าก่อน"},
        {L"kb.next_page",      L"หน้าต่อไป"},
        {L"kb.first_page",     L"หน้าแรก"},
        {L"kb.last_page",      L"หน้าสุดท้าย"},
        {L"kb.prev_archive",   L"ไฟล์ก่อน"},
        {L"kb.next_archive",   L"ไฟล์ต่อไป"},
        {L"kb.nav_back",       L"ย้อนกลับ"},
        {L"kb.nav_forward",    L"ไปข้างหน้า"},
        {L"kb.nav_up",         L"โฟลเดอร์แม่"},
        {L"kb.open_item",      L"เปิด/ขยาย"},
        {L"kb.fullscreen",     L"เต็มจอ"},
        {L"kb.zoom_reset",     L"รีเซ็ตซูม"},
        {L"kb.copy_image",     L"คัดลอกภาพ"},
        {L"kb.rotate_ccw",     L"หมุนทวนเข็มนาฬิกา"},
        {L"kb.rename",         L"เปลี่ยนชื่อ"},
        {L"kb.delete_file",    L"ลบไฟล์"},
        {L"kb.play_pause",     L"เล่น/หยุด"},
        {L"kb.refresh",        L"รีเฟรช"},
        {L"kb.help",           L"ช่วยเหลือ"},
        {L"kb.escape",         L"ออกจากเต็มจอ"},
        {L"kb.bookshelf",      L"สลับชั้นหนังสือ"},
        {L"kb.history",        L"สลับประวัติ"},
        {L"kb.list_view",      L"มุมมองรายการ"},
        {L"kb.grid_view",      L"มุมมองตาราง"},
        {L"kb.hover_preview",  L"แสดงตัวอย่างเมื่อโฮเวอร์"},
        {L"kb.settings",       L"ตั้งค่า"},
        {L"kb.view_cycle",     L"สลับโหมดแสดง"},
        {L"kb.bind_ltr",       L"เย็บสันซ้าย"},
        {L"kb.bind_rtl",       L"เย็บสันขวา"},
        ...
        {L"media.speed",        L"ความเร็วในการเล่น"},
        ...
        {L"help.subtitle",      L"โปรแกรมดูภาพ วิดีโอ และไฟล์บีบอัด"},
        {L"help.authorlabel",   L"ผู้พัฒนา:"},
        {L"help.authorname",    L"shimao"},
        {L"help.desclabel",     L"คำอธิบาย:"},
        {L"help.desc1",         L"เรียกดูไฟล์ ZIP/RAR/7z โดยตรง รองรับมุมมองคู่หน้าและเล่นวิดีโอ"},
        {L"help.desc2",         L""},
        {L"help.close",         L"ปิด"},
        {L"help.checkupdate",    L"ตรวจสอบอัปเดต"},
        {L"help.update.checking", L"กำลังตรวจสอบ..."},
        {L"help.update.latest",  L"คุณใช้เวอร์ชันล่าสุดแล้ว"},
        {L"help.update.available", L"v%s พร้อมใช้งาน"},
        {L"help.update.error",   L"ไม่สามารถตรวจสอบได้"},
        {L"help.update.download", L"ดาวน์โหลด"},
        {L"help.text.basic",
            L"## ดูภาพ\r\n"
